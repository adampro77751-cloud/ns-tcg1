...
export default async function AdminSpriteCodesPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-12">
      ...
      <div id="generate" className="mt-6 scroll-mt-6 rounded border border-zinc-200 p-4">
      ...
      <h2
        id="batches"
        className="mt-10 scroll-mt-6 text-sm font-semibold uppercase tracking-wide text-zinc-500"
      >
        Sprite Code Batches
      </h2>
      {batches.length === 0 ? (
        <p className="mt-3 text-sm text-zinc-500">No batches generated yet.</p>
      ) : (
